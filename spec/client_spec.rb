...
describe(Client) do
  ...
  describe('#==') do
    it('compares object attributes to determine if they are the same object') do
      test_client = Client.new({:id => nil, :name => "Eelin", :gender => "Female", :phone_number => 503-345-7898})
      test_client2 = Client.new({:id => nil, :name => "Eelin", :gender => "Female", :phone_number => 503-345-7898})
